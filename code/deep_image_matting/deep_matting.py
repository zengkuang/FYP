...
def main(args):
	...
	'''
	plt.figure()
	plt.imshow(trimap, cmap= plt.cm.gray)
	plt.show()
	'''		
	misc.imshow(trimap)
...
def parse_arguments(argv):
	...
	parser.add_argument('--alpha', type=str, help='input alpha')
	parser.add_argument('--rgb', type=str, help='input rgb')
	parser.add_argument('--gpu_fraction', type=float, help='how much gpu is needed, usually 4G is enough',default = 0.4)
